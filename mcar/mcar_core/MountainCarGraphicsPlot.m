function MountainCarGraphicsPlot( x,a ) 

% code originally written by Jose Antonio Martin
% See the web page http://www.dia.fi.upm.es/~jamartin/download.htm

% modified by Sridhar Mahadevan, 3/1/07. 
