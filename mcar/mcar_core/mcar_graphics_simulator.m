function  [nexts, reward, endsim] = mcar_graphics_simulator(state,action)
...
% numactions = mcar_actions; % coast, forward, backward
...
% show a nice graphics display 

if grafica==true
    MountainCarGraphicsPlot(state,action-1); 
end; 
